    ...
    return (
        <>
                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
                    <div className="flex items-center gap-2">
                        <Link href={route('home')} className="flex items-center gap-2 text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">
                            <img src="/logo.svg" alt="SmartLearn logo" className="h-6 w-6" />
            ...
            <main className="mt-20 flex flex-col gap-24 bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a] dark:text-[#EDEDEC]">
                {/* Hero */}
                <section className="relative isolate overflow-hidden pt-20 pb-18">
                    <div className="mx-auto flex max-w-7xl flex-col items-center px-4 text-center md:px-8">
                        <h1 className="mb-6 max-w-3xl text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl md:text-6xl">
                            Learn Smarter, <span className="text-[#f53003] dark:text-[#FF4433]">Grow Faster</span>
                        </h1>
                        <p className="mb-10 max-w-2xl text-lg leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            SmartLearn helps you master new skills with interactive courses, assessments and personalised learning paths – all in one intuitive platform.
                        </p>
                        <div className="flex flex-col items-center gap-4 sm:flex-row">
                            ...
                            <Link
                                ...
                                className="inline-block rounded border border-transparent px-8 py-3 font-medium text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                            >
                                Browse Courses
                            </Link>
                        </div>
                    ...
                    <div
                        aria-hidden="true"
                        className="pointer-events-none absolute -top-40 left-1/2 h-[30rem] w-[60rem] -translate-x-1/2 rounded-full bg-[#f53003]/20 blur-3xl dark:bg-[#FF4433]/20"
                    />
                </section>
                ...
                {/* Pricing */}
                <section id="pricing" className="mx-auto w-full max-w-7xl px-4 md:px-8">
