...
import { ArrowLeft, Plus, X, Search, Filter, Users } from 'lucide-react';
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Manage user enrollments and roles
              </p>
            </div>
          </div>
                    ...
                    <div className="max-h-60 overflow-y-auto space-y-2">
                      {filteredAvailableUsers.map((user) => (
                        <div key={user.id} className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor={`enroll-${user.id}`} className="flex items-center gap-2 cursor-pointer">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Users currently enrolled in this course
                </CardDescription>
              </div>
        ...
        {filteredAvailableUsers.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Users not yet enrolled in this course
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3">
