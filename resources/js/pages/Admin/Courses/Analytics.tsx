...
import { ArrowLeft, Bell, BookOpen, Calendar, FileText, MessageSquare, TrendingUp, Users } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">{stats.total_published_modules} published</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">{stats.total_assessments} assessments</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">{stats.total_announcements} announcements</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Overall completion and enrollment metrics</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">{stats.total_students} students enrolled out of 50 capacity</p>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">Average completion across all modules</p>
                            </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Student enrollment over the last 30 days</CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <div className="space-y-3">
                                    {enrollmentTrends.slice(-7).map((trend, index) => (
                                        <div key={index} className="flex items-center justify-between">
                                            <span className="text-sm text-muted-foreground">{formatDate(trend.date)}</span>
                                            <div className="flex items-center gap-2">
                                                <div className="h-2 w-20 rounded-full bg-gray-200">
                                                    <div
                                                        className="h-2 rounded-full bg-blue-600"
                                                        style={{
                                                            width: `${(trend.count / Math.max(...enrollmentTrends.map((t) => t.count))) * 100}%`,
                                                        }}
                                                    />
                                                </div>
                                                <span className="w-8 text-right text-sm font-medium">{trend.count}</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Latest activities and interactions in the course</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-medium">{stats.total_discussions + stats.total_announcements} interactions</span>
                            </div>

                            <div className="flex items-center justify-between">
                                <span className="text-sm">Assessment Coverage</span>
                                <span className="text-sm font-medium">{stats.total_assignments + stats.total_assessments} total</span>
                            </div>
                        </CardContent>
                    </Card>
